...
class NeuMF(nn.Module):
    def __init__(self, num_users, num_items, mf_dim=10, layers=[10]):
        ...
        init.kaiming_normal_(self.user_embedding_gmf.weight, nonlinearity='relu')
        init.kaiming_normal_(self.item_embedding_gmf.weight, nonlinearity='relu')
        init.kaiming_normal_(self.user_embedding_mlp.weight, nonlinearity='relu')
        init.kaiming_normal_(self.item_embedding_mlp.weight, nonlinearity='relu')

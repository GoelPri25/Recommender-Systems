...
from data_load import simple_load_data_rate as simple_load_data_rate1
from data_load import get_model_data as get_model_data1
from data_load_perpos import simple_load_data_rate as simple_load_data_rate2
from data_load_perpos import get_model_data as get_model_data2
...
for simple_load, get_model_data in data_loads:
    train_dict, valid_dict, test_dict, movie_num, user_num, removed_users_info = simple_load(rating_data_file, negative_sample_no_train=1, negative_sample_no_valid=100, threshold=3)

...
from data_process import get_all_noninteract_validation, get_non_interacted_movies, get_train_data, get_part_noninteract_validation, get_all_noninteract_test
...
for name, loader in loaders.items():
    ...
    val_user_input, val_movie_input, val_labels, neg_sample_val = get_all_noninteract_validation(val_dict, 

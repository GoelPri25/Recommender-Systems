...
gmf_model = torch.load('./5_gmf.pth', weights_only=True)  # GMF
mlp_model = MLP(num_users=user_num + 1, num_items=movie_num + 1, layers=layer)
mlp_model = torch.load('./mlp_best.pth', weights_only=True)  # MLP 
